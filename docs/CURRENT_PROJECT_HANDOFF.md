...
- Recalibrated true Low with a 165% architectural-fill lift and a restrained warm-neutral balance. The internal balanced tier retains its recovered 75% warm fill and artwork-light pool; High alone uses the accepted neutral architectural-light baseline.
