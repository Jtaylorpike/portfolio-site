...
- Recalibrated true Low with a 105% architectural-fill lift and stronger orange-amber balance. The internal balanced tier retains its recovered 75% warm fill and artwork-light pool; High alone uses the accepted neutral architectural-light baseline.
