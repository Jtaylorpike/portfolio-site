...
- Recalibrated Low and the internal balanced tier toward High's perceived brightness with a 105% architectural-fill lift and an explicit strong orange-amber light blend that remains visible through ACES tone mapping. High alone uses the accepted neutral architectural-light baseline.
