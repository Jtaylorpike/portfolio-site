...
```text
This is my current Taylor Pike portfolio site source. Read the docs folder first, especially CURRENT_PROJECT_HANDOFF.md, CURRENT_PROJECT_HANDOFF_PHASE6_ACTIVE.md, PROJECT_ROADMAP_CURRENT.md, and CHAT_TRANSFER_AND_UPLOAD_WORKFLOW.md. Treat the uploaded source as the source of truth. Phase 6 mobile 3D gallery controls is active. Phase 6F is the current touch-camera baseline and Phase 6G is the current horizontal-phone homepage hero baseline for the public site. Final public About copy should be written by me, not generated as finished copy.
```
